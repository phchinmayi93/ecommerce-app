...
const adURL = 'https://rukminim1.flixcart.com/lockin/774/185/images/CCO__PP_2019-07-14.png?q=50';
    ...
    <>
      ...
      <SmallText>
        <Typography>
          <StyledBadge style={{ color: "#00CC00", fontSize: "15px" }} />
        ...
        <Typography>
          <StyledBadge style={{ color: "#00CC00", fontSize: "15px" }} />
          Signup for Flipkart Paylater and get Flipkart Gift Card worth ₹100*
        </Typography>
        <Typography>
          <StyledBadge style={{ color: "#00CC00", fontSize: "15px" }} />
          5% cashback on Axis Bank Flipkart Debit Card up to ₹750 T&C
        </Typography>
        <Typography>
          <StyledBadge style={{ color: "#00CC00", fontSize: "15px" }} />
